...
return (
    <Container>
        <Wrapper>
            ...
            <Center>
                <Logo><Link style={{color:"black",textDecoration:"none"}} to='/'>Mega Store</Link></Logo>
            </Center>
            <Right>
                <MenuItem><Link style={{color:"black",textDecoration:"none"}} to='/Login'>Sign In</Link></MenuItem>
                <MenuItem><Link style={{color:"black",textDecoration:"none"}} to="/Register">Sign Up</Link></MenuItem>
                <MenuItem>
                    <Badge  badgeContent={2} color="primary">
                        <Link to='/Cart'><LocalMallOutlined style={{color:"black"}}/></Link>
                    </Badge>
                </MenuItem>
            </Right>
        </Wrapper>
